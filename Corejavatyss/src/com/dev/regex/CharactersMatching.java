...
public class CharactersMatching {
	...
	public static void main(String[] args) {
		...
		Matcher mat = pat.matcher("kirns0803@email.com");
		System.out.println(mat.matches());

		pat = Pattern.compile("\\w+\\s\\w+\\s\\w+"); // for first, middle, and last name // we can use D+ but it cannot
														// match perfect matching as required(in user perspective)
